...
(
   ...
   constraint FK_ATTRIBUER1_MOTCLE foreign key (MOTCLEID) references MOT_CLE (MOTCLEID),
   constraint FK_ATTRIBUER1_LIVRE foreign key (LIVREISBN) references LIVRE (LIVREISBN)
);
