...
INSERT INTO LIVRE  VALUES ('0000059001', 'Depuis l\'au-Dela', NULL, 22, 'TVA2', 'Avril 2017', NULL, 
			'Je me nomme Gabriel Wells. Je suis écrivain de romans à suspens. Ma nouvelle enquête est un peu particulière car elle concerne le meurtre de quelqu’un que je connais personnellement : Moi-même. J’ai été tué dans la nuit et je me demande bien par qui. Pour résoudre cette énigme j’ai eu la chance de rencontrer  Lucy Filipini. En tant que medium professionnelle elle parle tous les jours aux âmes des défunts. Et c’est ensemble, elle dans le monde matériel, moi dans le monde invisible que nous allons tenter de percer le mystère de ma mort.', 448, '56', NULL, NULL);
INSERT INTO LIVRE VALUES ('ISBN5601284002', 'Un monde apres l\'autre', NULL, 14.50, 'TVA2', '08/02/2018', NULL, 
			'Derrière l'innocente façade de St Mary, le secret du voyage dans le temps a été découvert et reste bien gardé. Les chercheurs en Histoire ont ainsi une méthode de travail tout à fait particulière : ils « étudient en temps réel les événements majeurs de l’Histoire ». En se faisant passer pour d’inoffensifs excentriques, ils tentent de répondre à certaines questions qui n'ont jamais été résolues, sans jamais toucher au cours de l’Histoire… au risque d’en mourir. par son ancien professeur afin de rejoindre l'équipe de l'Institut St Mary. Au cours de son étrange entretien d'embauche, Maxwell comprend vite les possibilités qui s’offrent à elle…  De la disparition de Pompéi aux tranchées de la Première Guerre mondiale, du grand incendie de Londres à la destruction de la bibliothèque d'Alexandrie, la jeune historienne va revivre d'extraordinaires événements. Alors qu’au sein de l institut naissent des enjeux de pouvoir…', 350, 30, NULL, NULL );
...
INSERT INTO LIVRE VALUES ('ISBN3456456011', 'Les Particules Elémentaires', NULL, 7.99, 'TVA2', 'Aout 1998', NULL, 
			'Les Particules élémentaires est un roman de Michel Houellebecq publié en 1998 chez Flammarion.  Ce deuxième roman de l'auteur a reçu l'ultime prix Novembre et a été élu par la rédaction de la revue Lire « meilleur livre de l année 1998 ».', 317, 14, NULL, NULL );
INSERT INTO LIVRE VALUES ('ISBN3456980012', 'Orgueil et Préjugés', NULL, 6.90, 'TVA2', 'Juillet 1813', NULL, 
			'Orgueil et Préjugés est un roman de la femme de lettres anglaise Jane Austen paru en 1813. Il est considéré comme l'une de ses œuvres les plus significatives et est aussi la plus connue du grand public. ', 236, 29, NULL, NULL );
INSERT INTO LIVRE VALUES ('ISBN0000059013', 'L'univers Élégant', NULL, 14.90, 'TVA2', 'Septembre 2000', NULL, 
			'Les physiciens aiment l'élégance, l'économie, la simplicité. Ils rêvent de théories permettant d'expliquer d'un seul coup le plus de phénomènes possibles.', 656, 75, NULL, NULL );
INSERT INTO LIVRE VALUES ('ISBN5601254014', 'Pierre Vernimmen', 'Finance d'entreprise 2020', 62.95, 'TVA2', 'Août 2019', NULL, 
			'Finance d'entreprise 2020 intègre les préoccupations environnementales et sociales qui changent la finance d’entreprise. Écrit par deux anciens banquiers d'affaires, actuellement business angels ou senior banker et professeurs à HEC Paris, « Le Vernimmen » est le manuel de gestion couvrant l'ensemble des domaines de la finance d'entreprise en partant à la fois de l'analyse des données comptables et des techniques de marché pour conduire à une analyse rigoureuse de toute décision financière sous ses aspects théoriques et pratiques. Véritable outil pédagogique, chaque chapitre de l'ouvrage est suivi d'un résumé, de questions et d'exercices actualisés avec leurs corrigés, et d'une bibliographie sélective.', 1220, 30, NULL, NULL );
INSERT INTO LIVRE VALUES ('ISBN3856995015', 'Trois sœurcières', NULL, 8.90, 'TVA2', 'Avril 1995', NULL, 
			'À Lancre, le roi Vérence meurt assassiné par son cousin le duc Kasqueth, qui prend sa place sur le trône afin de satisfaire sa femme ambitieuse. Vérence se retrouve à hanter son propre château. Son fils (ainsi que sa couronne) est caché dans une troupe de théâtre itinérante, grâce aux trois sorcières Mémé Ciredutemps, Nounou Ogg et Magrat Goussedail, pour qu'il échappe au même sort. Le duc Kasqueth tente alors denforcer les sorcières du pays à lui obéir, sans grand succès.', 320, 12, NULL, NULL );
INSERT INTO LIVRE VALUES ('ISBN0025684016', 'Carbone & Silicium', NULL, 22.90, 'TVA2', 'Août 2020', NULL, 
			'Carbone est un personnage qui s'investit dans le monde, qui veut être une actrice de son évolution. Silicium, lui, s'en détache et cherche à en découvrir toute la beauté. Le plus important, au-delà de leur trajectoire personnelle et parfois éloignée, c'est le lien qui les unit.', 272, 26, NULL, NULL );
...
INSERT INTO STATUT VALUES
	('ST01', 'Validée en attente de traitement'),
    ('ST02', 'En cours de préparation'),
    ('ST03', 'Commande remis au transporteur'),
    ('ST04', 'Commande en cours de livraison'),
    ('ST05', 'Commande réceptionnée'),
    ('ST06', 'Commande retournée pour échange'),
    ('ST07', 'Echange remis au transporteur'),
    ('ST08', 'Echange en cours de livraison'),
    ('ST09', 'Echange réceptionné'),
...
INSERT INTO ADRESSE VALUES 
	...
	('00015ADR', NULL, 'Bouvier', 'Corinne', '9', 'rue Clement Marot',NULL,  '93380', 'Pierrefitte sur Seine', 'FRANCE', NULL, NULL),
