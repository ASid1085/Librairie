...
public class Connexion {
	...
	private String BDD2 = "Librairie2"; // Nom de la BDD de Marine pour effectuer les tests "LibrairieTEST" Librairie2
	private String url = "jdbc:mysql://localhost:3306/" + BDD2;
	private String user = "root";
	private String mdp = "Sidonie1"; // Mot de passe du root de Marine "2021PasswordMySQL" Sidonie1
